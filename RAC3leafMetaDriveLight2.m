...
%Cassava simulation
%RAC3leafMetaDriveLight2('Light150015.txt',0,0)
%RAC3leafMetaDriveLight2('LightZhuL6.txt',0,0)
%Output 
%Transpiration(mol m-2 day-1) Photosynthesis(mol m-2 day-1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function AandW=RAC3leafMetaDriveLight2(inputfile,Pst,PRca)
%clear all;
...
Lightdata=Lightd.data;
 global lightM;
% lightM(:,1)=Lightdata(217:1220,1);-4.5;
...
%      end
%  end
%  lightM(:,3)=Lightdata(721:1440,39);
%  lightM(:,4)=Lightdata(721:1440,41);
...
dKd=CasSTdata(simNo,3)*3;
dKi=CasSTdata(simNo,4)*3;
