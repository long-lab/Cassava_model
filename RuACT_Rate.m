...
%EC1=-((C^2*Eaf^2 + 2*C^2*Eaf*Ke3 - 2*C^2*Eaf*MT + C^2*Ke3^2 + 2*C^2*Ke3*MT + C^2*MT^2 + 2*C*Eaf*Ke2*Ke3 + 2*C*Ke2*Ke3^2 + 2*C*Ke2*Ke3*MT + Ke2^2*Ke3^2)^(1/2) - C*Eaf + C*Ke3 + C*MT + Ke2*Ke3)/(2*(C + Ke2))
%EC2=-(C*Ke3 - C*Eaf - (C^2*Eaf^2 + 2*C^2*Eaf*Ke3 - 2*C^2*Eaf*MT + C^2*Ke3^2 + 2*C^2*Ke3*MT + C^2*MT^2 + 2*C*Eaf*Ke2*Ke3 + 2*C*Ke2*Ke3^2 + 2*C*Ke2*Ke3*MT + Ke2^2*Ke3^2)^(1/2) + C*MT + Ke2*Ke3)/(2*(C + Ke2))
%EC0=solve('EC/C*Ke2+EC+EC*MT/(Ke3+EC)= Eaf','EC');
